...
ExprASTNodeTempl::ExprASTNodeTempl(const std::vector<NodeType>& node_types, const std::vector<DataType>& result_types) : 
    node_types(node_types), result_types(result_types) {

}

ASTNode* ExprASTNodeTempl::generate(NodeType node_type, ASTGenerator* generator) {
...
std::vector<DataType> ExprASTNodeTempl::getPossibleReturnTypes() {
