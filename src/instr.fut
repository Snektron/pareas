...
let node_instr(node_type: NodeType) (data_type: DataType) (instr_offset: i64) : u32 =
    ...
    -- Casts
    case (#cast_expr, _, _) ->          0b0000000_00000_00000_000_00000_1110011 -- TODO
    case (#deref_expr, #int, 0) ->      0b0000000_00000_00000_010_00000_0000011 -- LW 0(rs1)

    -- Variables
    case (#decl_expr, _, _) ->          0b0000000_00000_00000_000_00000_1110011 -- TODO
    case (#id_expr, _, _) ->            0b0000000_00000_00000_000_00000_1110011 -- TODO
...
let node_get_parent_arg_idx (node: Node) (instr_offset: i64) : i64 =
    match (node.node_type, instr_offset)
        ...
        case (#decl_expr, 1) -> parent_arg_idx node
        case (#id_expr, 1) -> parent_arg_idx node
        case _ ->
            -1
...
let get_node_instr(node: Node) (instr_no: i64) (node_index: i64) (registers: []i64) (instr_offset: i64): (i64, i64, Instr) =
...
let compile_node [tree_size] (tree: Tree[tree_size]) (registers: []i64) (instr_offset: [tree_size]i64) (node_index: i64) =
    ...
    let node_instr = instr_offset[node_index] in
        [
            get_node_instr node node_instr node_index registers 0,
            if has_instr node.node_type 1 then get_node_instr node (node_instr+1) node_index registers 1 else (-1, -1, EMPTY_INSTR)
        ]
